...
public class CmdAlter extends DBCmd {
    ...
    public String query(DBServer server) {
        ...
        // Prevent modifying 'id' column
        if (columnName.equalsIgnoreCase("id")) {
            return "[ERROR] Cannot alter primary key column 'id'.";
        }
        ...
        for (int i = 1; i < tableContent.size(); i++) {
            ...
            if (alterType.equalsIgnoreCase("ADD")) {
                newRow.add("NULL"); // ✅ Add NULL for new column
            ...
            while (newRow.size() < newColumnCount) {
                newRow.add("NULL"); // ✅ Ensure all rows remain valid
            }
